    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-md-5 mb-xl-10">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="row mt-3" method="POST" action="{{ route('kelola_banner.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="">
                                    <input type="number" name="urutan" class="form-control form-control-normal" placeholder="Urutan...">
                                </div>
                            </div>
